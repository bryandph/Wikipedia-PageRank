...
public final class wikipediapagerank {
	...
	private static final File PAGE_ID_TITLE_SQL_FILE = new File("../enwiki-latest-page.sql.gz");           // Original input file
	private static final File PAGE_ID_TITLE_RAW_FILE = new File("wikipedia-pagerank-page-id-title.raw");  // Cache after preprocessing
	
	private static final File PAGE_LINKS_SQL_FILE = new File("../enwiki-latest-pagelinks.sql.gz");   // Original input file
